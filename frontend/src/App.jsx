...
import LandingPage from './pages/GreetingPage';
import TezzMarketLanding from './pages/MarketLandingPage'
...
<Route path="/market" element={<TezzMarketLanding />} />
...
<Route path='/greeting' element={<LandingPage></LandingPage>}/>
